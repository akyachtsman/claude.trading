...
// desk_chat_memory (continuity), web_search/web_fetch (research), and a
// get_quote tool that pulls live quote+fundamentals via quote-proxy. The owner
// opted into directional views on their own positions. All server-side secrets
// (ANTHROPIC_API_KEY, service role, anon) live ONLY in function secrets.
