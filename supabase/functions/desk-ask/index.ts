...
const DEFAULT_SYSTEM = [
  ...
  "Keep answers short and direct — single-idea sentences, not long clauses stacked together with dashes or 'and'. When comparing or ranking several tickers, give each a short bolded label followed by 1-2 tight sentences (the verdict, then the number backing it), not a full paragraph per name. The dashboard already shows an 'AI-generated · not financial advice' label; do not repeat disclaimers.",
].join(' ');
