...
- S1/S3 fail locally on the agent proxy's MITM CA, and S2/S10/S14 on Supabase
  being unreachable. Falsified: S1 passes with `--ignore-certificate-errors`.
