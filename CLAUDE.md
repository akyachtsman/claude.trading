...
|---|---|---|---|
| S5 | Demo lamps | With `?demo=1`, the desk-state cluster (Accounts header since 2026-07-22) shows "Demo data" and every panel lamp (brief, news, ask) reads Demo | Any lamp shows LIVE/EOD/LOCKED in demo |
